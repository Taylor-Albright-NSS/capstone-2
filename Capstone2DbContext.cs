    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Enemy>().HasData(new Enemy[]
        {
            new Enemy
            {
                Id = 1,
                UserId = 1,
                ImageUrl = "https://https://firebasestorage.googleapis.com/v0/b/capstone2-3243e.firebasestorage.app/o/uploads%2Fmudling.png?alt=media&token=e88f74ca-310b-4d42-8bf2-8f659ce998cf",
                Name = "Mudling",
                MinLevel = 1,
                MaxLevel = 5,
                AttackPower = 5,
